# Generated by Django 2.1.4 on 2019-01-08 07:03
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('argument', models.CharField(max_length=255, verbose_name='Argument')),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='cameras2', to='inventory.RecorderProfile', verbose_name='Recorder Profile (secondary)'),
        ),
        migrations.AddField(
            model_name='camera',
            name='schedule',
